...
class StatusUpdate:
    ...
    biomarkers: dict[str, float]
        list of biomarkers
    status_action: int
        activation (1) or de-activation (0)
    status_detail: str
    ...
    """
    __slots__ = [
        'type_status', 'synthetic', 'status_action', 'status_detail',
        'status_value', 'biomarkers', 'arrival_time',
    ...
    def __str__(self):
        return '{0} {1} status update at time {2} ({3}: {4})'.format(
            self.status_action,
            self.type_status,
            self.arrival_time,
            self.status_detail,
